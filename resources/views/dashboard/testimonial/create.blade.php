    ...
    <div class="relative p-4 w-full max-w-md max-h-full">
        ...
        <div class="relative bg-white rounded-lg shadow  :bg-gray-700">
            ...
            <div class="p-4 md:p-5">
                <form class="space-y-4" action="/dashboard/testimonial" method="post" enctype="multipart/form-data">
                    @csrf
                    <div>
                        <label for="name"
                    ...
                    <div>
                        <label for="description" class="block mb-2 text-sm font-medium text-gray-900  :text-white">Your
                            message</label>
                        <textarea id="description" name="comment" rows="4"
                    ...
                    <div>
                        ...
                        <input
                            ...
                            id="image_testi" type="file" name="image_testi" onchange="previewImage()">
                        @error('image_testi')
                            <p class="mt-2 text-xs text-red-600 font-medium">{{ $message }}</p>
                        @enderror
                    </div>
