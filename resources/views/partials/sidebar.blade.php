<nav class="fixed top-0 z-50 w-full bg-white border-b border-gray-400  :bg-gray-800  :border-gray-700">
        ...
        <div class="flex items-center justify-between">
            <div class="flex items-center justify-start rtl:justify-end">
                ...
                <a href="/dashboard" class="flex ms-2 md:me-24">
                    <img src="./../assets/img/logo-hisocial.png" class="h-8 me-3" alt="HiSocial Logo" />
                ...
                <div class="flex items-center ms-3">
                    ...
                    <div class="z-50 hidden my-4 text-base list-none bg-white divide-y divide-gray-100 rounded shadow "
                        ...
                        <div class="px-4 py-3 border-b " role="none">
                            <p class="text-sm text-gray-900 py-3" role="none">
                                {{ Auth()->user()->name }}
                            </p>
...
<aside id="logo-sidebar"
    class="fixed top-0 left-0 z-40 w-64 h-screen pt-20 transition-transform -translate-x-full bg-white border-r border-gray-400 sm:translate-x-0  :bg-gray-800  :border-gray-700"
    aria-label="Sidebar">
        ...
        <ul class="space-y-2 font-medium">
            <li>
                <a href="/dashboard"
                    ...
                    <svg class="w-5 h-5 text-gray-500 transition duration-75  :text-gray-400 group-hover:text-gray-900  :group-hover:text-white"
            ...
            <li>
                <button type="button"
                    class="flex items-center w-full p-2 text-base text-gray-900 transition duration-75 rounded-lg group hover:bg-gray-100   :text-white   :hover:bg-gray-700"
